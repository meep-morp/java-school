...
public class Swagger2Config {
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Lambda School Projects")
                .description("Lambda Schools Project")
                .contact(new Contact("Adrian Hartley",
                        "http://www.lambdaschool.com",
                        "hannah-hartley@lambdastudents.com"))
                .license("MIT")
